...
\begin{multicols}{2}
\section*{List of examinable topics covered in 2021}
\begin{itemize}
...
\item Structural recursion: linked lists and binary trees. Basic idea of how to represent recursive data structures in Julia.
\item Data structures and the operations they are designed for: arrays, linked lists, stacks, queues, hash tables, binary trees. 
